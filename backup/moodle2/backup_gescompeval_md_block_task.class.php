...
require_once($CFG->dirroot . '/blocks/gescompeval_md/backup/moodle2/backup_gescompeval_md_stepslib.php'); // Because it exists (must)

/**
 * assignment backup task that provides all the settings and steps to perform one
 * complete backup of the block
 */
class backup_gescompeval_md_block_task extends backup_block_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new backup_gescompeval_md_block_structure_step('gescompeval_md_structure', 'gescompeval_md.xml'));
    }
